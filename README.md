...
Код распространяется под лицензией [MIT](./LICENSE) — его можно свободно
использовать, изменять и встраивать в собственные проекты, включая коммерческие,
при условии сохранения текста лицензии и указания копирайта. Софт поставляется
«как есть», без гарантий.

Лицензия покрывает исходный код. Название «InstraDoc», логотип и иконки приложения
под неё не попадают: форк не должен выдавать себя за оригинальный проект.
